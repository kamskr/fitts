...
class $AssetsIconsGen {
  ...
  /// File path: assets/icons/ic_menu_history.svg
  SvgGenImage get icMenuHistory =>
      const SvgGenImage('assets/icons/ic_menu_history.svg');

  /// File path: assets/icons/ic_menu_home.svg
  SvgGenImage get icMenuHome =>
      const SvgGenImage('assets/icons/ic_menu_home.svg');

  /// File path: assets/icons/ic_menu_plans.svg
  SvgGenImage get icMenuPlans =>
      const SvgGenImage('assets/icons/ic_menu_plans.svg');

  /// File path: assets/icons/ic_menu_stats.svg
  SvgGenImage get icMenuStats =>
      const SvgGenImage('assets/icons/ic_menu_stats.svg');
